...
def hide_debugger_peb(handle, is64):
    """
    Hedef sürecin PEB tablosuna sızarak BeingDebugged ve NtGlobalFlag
    değerlerini sıfırlar. Bu sayede anti-debug mekanizmaları aşılır.
    """
    try:
...
def catch_memory_access(pid, address, size_bytes, is64, timeout_ms=20000, on_status=None):
    ...
    # YENİ: Oyuna yakalanmadan PEB manipülasyonu ile Görünmezlik Modunu aktif et
