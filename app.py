...
class SheetOnion(tk.Tk):
    ...
    def _build_table(self):
        ...
        ttk.Button(r1, text="➕ Add manual", command=self._add_manual).pack(side="left")
        ...
        ttk.Button(r2, text="🎯 Değere Göre Ele (Filtrele)", style="Accent.TButton", command=self._filter_pointers_in_table).pack(side="left", padx=6)
