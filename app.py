...
class SheetOnion(tk.Tk):
    ...
    def _build_table(self):
        frame = ttk.LabelFrame(self, text="Saved addresses & Dynamic Pointers", padding=4)
        ...
        for col, txt, w, anchor in (("freeze", "Freeze", 70, "center"), ("desc", "Description", 200, "w"), ("addr", "Address / Pointer", 240, "w"), ("type", "Type", 110, "center"), ("value", "Value", 180, "e")):
...
class PointerScannerDialog(tk.Toplevel):
    ...
    def _do_rescan(self):
        ...
        for p in self.found_paths:
            # Canlı dinamik çözümleme motoruyla kontrol et
